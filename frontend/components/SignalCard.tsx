  ...
  const theme =
    accent === 'red'
      ? {
          ...
          eyebrow: 'rgba(var(--lotte-cream-rgb), 0.8)',
          title: 'rgba(var(--lotte-cream-rgb), 0.92)',
          value: 'var(--text-on-accent)',
          body: 'var(--text)',
          detail: 'var(--muted)',
        }
      : accent === 'navy'
        ? {
            ...
            eyebrow: 'rgba(var(--lotte-cream-rgb), 0.78)',
            title: 'rgba(var(--lotte-cream-rgb), 0.94)',
            value: 'var(--text-on-accent)',
            body: 'var(--text)',
            detail: 'var(--muted)',
          }
